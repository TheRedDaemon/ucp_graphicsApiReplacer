...
if next(addrFail) ~= nil then
  ...
  print("'ucp_windowToOpenGL' can not be initialized.")
  return
end
...
package.cpath = "ucp/modules/windowToOpenGL/?.dll;" .. package.cpath    -- find package

local ucpOpenGL = require("ucp_windowToOpenGL") -- loads the dll in memory and runs luaopen_ucp_windowToOpenGL
